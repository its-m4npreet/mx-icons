...
export default function 3dDRotateTwotone({
  size = 24,
  color = "#292D32",
  strokeWidth = 1.5,
  className = "",
...
<path opacity="0.4" d="M2 9C2 5.13 5.13 2 9 2L7.95001 3.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </Icon>
  );
}
