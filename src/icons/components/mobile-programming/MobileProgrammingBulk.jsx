...
export default function MobileProgrammingBulk({
  size = 24,
  color = "#292D32",
  strokeWidth = 1.5,
  className = "",
...
<path d="M14.9997 2V3.5C14.9997 4.32 14.3197 5 13.4997 5H10.4697C9.6597 5 8.9897 4.34003 8.9697 3.53003L8.92969 2H14.9997Z" fill="currentColor"/>
    </Icon>
  );
}
