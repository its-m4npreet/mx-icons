...
export default function TextBlockOutline({
  size = 24,
  color = "#292D32",
  strokeWidth = 1.5,
  className = "",
...
<path d="M12 17.0402C11.59 17.0402 11.25 16.7002 11.25 16.2902V7.93018C11.25 7.52018 11.59 7.18018 12 7.18018C12.41 7.18018 12.75 7.52018 12.75 7.93018V16.3002C12.75 16.7102 12.41 17.0402 12 17.0402Z" fill="currentColor"/>
    </Icon>
  );
}
